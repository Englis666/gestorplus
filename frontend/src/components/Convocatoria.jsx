...
import logoGP from "../assets/GestorplusXFayette.png";  // Importa la imagen correctamente
    ...
    return (
        <div style={{ background: "linear-gradient(to bottom, #E3F2FD, #ECF0F1)" }}>
                        ...
                        <div key={index} className="col">
                            ...
                            >
                                ...
                                <p className="text-muted">
                                    Convocatorias disponibles: {convocatorias.filter(c => c.nombreCargo === cargo).length}
                                </p>
                            </div>
                        </div>
                    ))}
            ...
            <section className="container py-5">
                <h1 className="text-primary fw-bold text-center mb-4">Convocatorias Recientes</h1>
                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                    {filteredConvocatorias.slice(0, 3).map((convocatoria, index) => (
                        <div key={convocatoria.idconvocatoria || `${convocatoria.idcargo}-${index}`} className="col">
                            <div className="card shadow-lg rounded-4 border-0 hover-scale" style={{ transition: "transform 0.3s ease" }}>
                                <div
