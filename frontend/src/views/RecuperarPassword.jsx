...
const RecuperarPassword = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post("http://localhost/gestorplus/backend/", formData, {
        ...
        .then((response) => {
            ...
            if (res?.status === 'success'){
                alert("Correo enviado con instrucciones para recuperar tu contraseña.");
            } else {
                alert("Hubo un problema al enviar el mensaje de recuperación a tu correo.");
            }
        })
        .catch((error) => {
                        ...
                        <div className="card border-0 shadow rounded-4 overflow-hidden">
                            <div className="row g-0">
                                <div className="col-md-6 d-flex flex-column justify-content-center align-items-center text-white p-4" style={{
                                    ...
                                    <h3 className="fw-bold text-center">Recupera tu contraseña</h3>
                                    <p className="text-center small">Introduce tu correo y te enviaremos instrucciones</p>
                                </div>
