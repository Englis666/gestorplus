...
const UploadContractModal = ({ isOpen, onClose, num_doc, nombres, idvinculacion }) => {
    ...
    const handleFileUpload = async () => {
        ...
        formData.append("idvinculacion", idvinculacion); // Asegúrate de enviar idvinculacion también
        ...
        try {
            ...
            // Por si se necesita depurar la subida de el contrato
        ...
        <div className={`modal fade ${isOpen ? "show d-block" : ""}`} tabIndex="-1" role="dialog">
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content p-4">
                    ...
                    <p>Aquí sube el PDF del contrato para el empleado con número de identificación {num_doc} y nombres {nombres}</p>
