...
const GenerarPazYSalvo = ({ form, empleados, onChange, onSubmit }) => {
  ...
  const validar = (campo = null, valor = null) => {
    ...
    else delete nuevosErrores.motivo;

    if (!f.fechaEmision)
      nuevosErrores.fechaEmision = "Debes seleccionar una fecha.";
    else delete nuevosErrores.fechaEmision;

    if (!f.estado || f.estado.trim().length < 3)
      nuevosErrores.estado = "El estado debe tener al menos 3 caracteres.";
    else delete nuevosErrores.estado;

    if (!f.empleado) nuevosErrores.empleado = "Selecciona un empleado.";
    else delete nuevosErrores.empleado;
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="mb-3">
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  className={`form-select ${
                    errores.empleado && tocado.empleado ? "is-invalid" : ""
                  }`}
                  value={form.empleado}
                  onChange={(e) => {
                    onChange(e);
              ...
              <input
                ...
                className={`form-control ${
                  errores.motivo && tocado.motivo ? "is-invalid" : ""
                }`}
                value={form.motivo}
                onChange={(e) => {
                  onChange(e);
            ...
            <div className="mb-3">
              ...
              <input
                ...
                name="fechaEmision"
                className={`form-control ${
                  errores.fechaEmision && tocado.fechaEmision
                    ? "is-invalid"
                    : ""
                }`}
            ...
            <div className="mb-3">
              ...
              <input
                ...
                name="estado"
                className={`form-control ${
                  errores.estado && tocado.estado ? "is-invalid" : ""
                }`}
                value={form.estado}
                onChange={(e) => {
                  onChange(e);
