...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-01-2025 a las 23:18:50
...
(1, 'Arquitecto de software', 'Buscamos un Arquitecto de Software con experiencia en el diseño, desarrollo e implementación de soluciones tecnológicas innovadoras. El candidato ideal debe ser capaz de liderar la arquitectura de sistemas complejos, asegurar la calidad del software y trabajar de la mano con equipos de desarrollo para garantizar la escalabilidad y eficiencia de las soluciones. Si tienes pasión por la tecnología y el desarrollo de software de alto impacto, ¡únete a nuestro equipo!', 'ASDASD', 55000.00, 50, 1),
(2, 'Desarollador de software', 'Test de descripcion para convocatoria de desarollo de software', 'Importante empresa que brinda servicios de soporte técnico a software propio requiere para su equipo de trabajo un analista de soporte nacional para realizar las siguientes funciones:\r\n\r\n-Planear las visitas e implementaciones programadas\r\n-Planear el presupuesto de las visitas programadas\r\n-Ejecución visitas e implementaciones programadas\r\n-Apoyo al soporte técnico de la aplicación EFORCE vía telefónica, mail y skype.\r\n-Escalar casos a desarrollo mediante el analista de soporte asignado\r\n-Recibir requerimientos de parte de los clientes y direccionar al coordinador o consultores\r\n-Ejecutar capacitaciones al cliente.\r\n\r\nHorario: lunes a viernes 8:00 am - 6pm y sábados 8:00 a 12:00\r\nSalario: 1.606.000 + auxilio de transporte 162.000 + prestaciones de ley\r\nRequerimientos\r\n\r\nEducación mínima: Universidad / Carrera técnica\r\n1 año de experiencia', 1600000.00, 2, 1);
...
(5, 'Tecnico', 'Desarollador', 'Vigente', '2025-01-07', '2025-01-21', 'Tecnologo', 'SENA', 'NQS 30 comnplejo sur', 23),
(6, 'Tecnico', 'Desarollador', 'Vigente', '0000-00-00', '0000-00-00', 'Tecnologo', 'SENA', 'NQS 30 comnplejo sur', 23);
...
--
-- Volcado de datos para la tabla `evaluacionessg`
--
...
CREATE TABLE `experiencialaboral` (
  `idexperienciaLaboral` int(45) NOT NULL,
...
INSERT INTO `experiencialaboral` (`idexperienciaLaboral`, `profesion`, `descripcionPerfil`, `fechaInicioExp`, `fechaFinExp`, `hojadevida_idHojadevida`) VALUES
(1, 'ejemplOProfesion', 'Descripcion ejemplo', '2025-01-08', '2025-01-15', 23);
...
(23, '2025-01-18', 'CALLE 896', 'TEST API', 'API TEST', '45214212', '1234123', b'1'),
...
(48, '2024-12-08', '17:40:00', '01:40:00', 1014, 0),
(49, '2024-12-08', '18:04:00', '02:04:00', 1014, 0),
...
(94, '2025-01-04', '08:01:00', '16:01:00', 1014, 1),
(95, '2025-01-04', '08:36:00', '16:36:00', 1014, 1),
(96, '2025-01-04', '08:36:00', '16:36:00', 1014, 1),
(97, '2025-01-04', '09:42:00', '17:42:00', 1014, 1),
(98, '2025-01-05', '12:22:00', '20:22:00', 1014, 1),
(99, '2025-01-05', '20:34:00', '04:34:00', 1014, 1),
(100, '2025-01-06', '10:15:00', '18:15:00', 1014, 1),
(101, '2025-01-06', '11:29:00', '19:29:00', 1014, 1),
(102, '2025-01-06', '14:10:00', '22:10:00', 1014, 1),
(103, '2025-01-07', '13:39:00', '21:39:00', 1014, 1),
(104, '2025-01-07', '14:41:00', '22:41:00', 1014, 1),
(105, '2025-01-07', '16:04:00', '00:04:00', 1014, 1),
(106, '2025-01-07', '17:16:00', '01:16:00', 1014, 1),
(107, '2025-01-07', '17:31:00', '01:31:00', 1014, 1),
(108, '2025-01-08', '13:36:00', '21:36:00', 1014, 1),
(109, '2025-01-08', '14:38:00', '22:38:00', 1014, 1),
(110, '2025-01-08', '19:23:00', '03:23:00', 1014, 1),
(111, '2025-01-08', '19:26:00', '03:26:00', 1014, 1),
(112, '2025-01-09', '22:50:00', '06:50:00', 1014, 1),
(113, '2025-01-15', '11:32:00', '19:32:00', 1014, 1),
(114, '2025-01-15', '11:53:00', '19:53:00', 10224, 1),
(115, '2025-01-15', '11:57:00', '19:57:00', 1014, 1),
(116, '2025-01-15', '11:57:00', '19:57:00', 10224, 1),
(117, '2025-01-15', '12:32:00', '20:32:00', 10224, 1),
(118, '2025-01-15', '12:35:00', '20:35:00', 10224, 1),
(119, '2025-01-15', '12:42:00', '20:42:00', 10224, 1),
(120, '2025-01-15', '12:50:00', '20:50:00', 10224, 1),
(121, '2025-01-15', '14:02:00', '22:02:00', 10224, 1),
(122, '2025-01-15', '14:11:00', '22:11:00', 1014, 1),
(123, '2025-01-15', '14:12:00', '22:12:00', 10224, 1),
(124, '2025-01-16', '11:15:00', '19:15:00', 10224, 1),
(125, '2025-01-16', '13:01:00', '21:01:00', 10224, 1),
(126, '2025-01-16', '13:59:00', '21:59:00', 10224, 1),
(127, '2025-01-16', '13:59:00', '21:59:00', 10224, 1),
(128, '2025-01-18', '11:46:00', '19:46:00', 10224, 1),
(129, '2025-01-18', '11:51:00', '19:51:00', 1014, 1),
(130, '2025-01-18', '11:51:00', '19:51:00', 10224, 1),
(131, '2025-01-18', '13:57:00', '21:57:00', 10224, 1),
(132, '2025-01-22', '15:33:00', '23:33:00', 10224, 1),
(133, '2025-01-25', '16:13:00', '00:13:00', 10224, 1),
(134, '2025-01-25', '17:15:00', '01:15:00', 10224, 1),
(135, '2025-01-26', '14:36:00', '22:36:00', 10224, 1),
(136, '2025-01-26', '14:36:00', '22:36:00', 10224, 1),
(137, '2025-01-26', '18:08:00', '02:08:00', 10224, 1),
(138, '2025-01-27', '20:44:00', '04:44:00', 10224, 1),
(139, '2025-01-28', '13:52:00', '21:52:00', 10224, 1),
(140, '2025-01-28', '15:44:00', '23:44:00', 10224, 1),
(141, '2025-01-28', '17:10:00', '01:10:00', 10224, 1);
...
CREATE TABLE `notificacion` (
  ...
  `estadoNotificacion` varchar(155) NOT NULL,
...
(103, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
(104, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
...
(106, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
(107, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
(108, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
(109, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
(110, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
(111, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
(112, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
(113, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
...
(115, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
(116, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 10224 y con el nombre Alex', NULL, '1', 'Jornada', 10224),
...
(118, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 10224 y con el nombre Alex', NULL, '1', 'Jornada', 10224),
...
(120, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 10224 y con el nombre Alex', NULL, '1', 'Jornada', 10224),
(121, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 10224 y con el nombre Alex', NULL, '1', 'Jornada', 10224),
(122, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
(123, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 10224 y con el nombre Alex', NULL, '1', 'Jornada', 10224),
(124, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 10224 y con el nombre Alex', NULL, '1', 'Jornada', 10224),
(125, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 10224 y con el nombre Alex', NULL, '1', 'Jornada', 10224),
(126, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 10224 y con el nombre Alex', NULL, '1', 'Jornada', 10224),
...
(129, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 1014 y con el nombre TEST', NULL, '1', 'Jornada', 1014),
...
(135, 'Ausencia aceptada', NULL, '', 'Aceptacion', 0),
(136, 'Ausencia rechazada', NULL, '', 'Rechazo', 0),
(137, 'Ausencia rechazada', NULL, '', 'Rechazo', 0),
(138, 'Ausencia aceptada', NULL, '', 'Aceptacion', 0),
(139, 'Ausencia rechazada', NULL, '', 'Rechazo', 0),
(140, 'Ausencia rechazada', NULL, '', 'Rechazo', 0),
(141, 'Ausencia rechazada', NULL, '', 'Rechazo', 0),
(142, 'Ausencia rechazada', NULL, '', 'Rechazo', 0),
(143, 'Ausencia rechazada', NULL, '', 'Rechazo', 0),
...
(145, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 10224 y con el nombre Alex', NULL, '1', 'Jornada', 10224),
...
(149, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 10224 y con el nombre Alex', NULL, '1', 'Jornada', 10224),
(150, 'Nueva jornada registrada por inicio de sesión para el usuario con documento: 10224 y con el nombre Alex', NULL, '1', 'Jornada', 10224);
...
--
-- Estructura de tabla para la tabla `quejareclamo`
--
...
--
-- Volcado de datos para la tabla `quejareclamo`
--

INSERT INTO `quejareclamo` (`idquejaReclamo`, `chat_idChat`, `usuario_num_doc`, `mensajes`, `created_at`) VALUES
(3, 0, 1014, 'asd', '2024-12-26 23:09:10'),
(4, 0, 1014, 'asdasdasdasdad', '2024-12-26 23:11:06'),
(5, 0, 1014, 'asd', '2024-12-27 21:28:38'),
(6, 0, 1014, 'aS', '2024-12-27 23:59:37'),
(7, 0, 1014, 'asd', '2024-12-28 16:24:25'),
(8, 0, 1014, 'Hola', '2024-12-28 16:24:39'),
(9, 0, 1014, 'Como estas', '2024-12-28 16:24:43'),
(10, 1, 1014, 'Hola', '2025-01-06 16:33:07'),
(11, 1, 1014, 'miau', '2025-01-10 03:51:02');
...
--
-- Indices de la tabla `quejareclamo`
--
...
--
ALTER TABLE `estudio`
  MODIFY `idestudio` int(45) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `experiencialaboral`
  MODIFY `idexperienciaLaboral` int(45) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `jornada`
  MODIFY `idJornada` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;

--
-- AUTO_INCREMENT de la tabla `notificacion`
--
ALTER TABLE `notificacion`
  MODIFY `idnotificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
...
--
-- AUTO_INCREMENT de la tabla `quejareclamo`
--
ALTER TABLE `quejareclamo`
  MODIFY `idquejaReclamo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
