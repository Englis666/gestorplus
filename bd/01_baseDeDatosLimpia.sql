...
-- Fin del script
SOURCE /var/www/html/gestorplus/bd/02_all_userPrivileges.sql;
SOURCE /var/www/html/gestorplus/bd/03_all_procedures.sql;
SOURCE /var/www/html/gestorplus/bd/04_all_triggers.sql;
SOURCE /var/www/html/gestorplus/bd/05_all_views.sql;

-- Si es docker las rutas serian 
--SOURCE /docker-entrypoint-initdb.d/02_all_userPrivileges.sql;
--SOURCE /docker-entrypoint-initdb.d/03_all_procedures.sql;
--SOURCE /docker-entrypoint-initdb.d/04_all_triggers.sql;
--SOURCE /docker-entrypoint-initdb.d/05_all_views.sql;