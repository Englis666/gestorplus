...
import { obtenerCargos } from "../../../frontend/src/services/Cargos";
import { obtenerConvocatorias } from "../../../frontend/src/services/Convocatorias";
...
const TablaConvocatorias = () => {
  ...
  useEffect(() => {
    axios
      .get(API_URL, { params: { action: "obtenerCargos" } })
      .then((response) => {
